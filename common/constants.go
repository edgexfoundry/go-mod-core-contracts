...
const (
	...
	ApiDeviceCallbackNameRoute  = ApiDeviceCallbackRoute + "/" + Name + "/:" + Name
	ApiProfileCallbackNameRoute = ApiProfileCallbackRoute + "/" + Name + "/:" + Name
	ApiWatcherCallbackNameRoute = ApiServiceCallbackRoute + "/" + Name + "/:" + Name
