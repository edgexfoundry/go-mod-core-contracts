...
var TestScheduleEvent = ScheduleEvent{Created: TestBaseObject.Created, Modified: TestBaseObject.Modified, Origin: TestBaseObject.Origin, Name: TestScheduleEventName, Schedule: TestSchedule.Name, Addressable: TestAddressable, Parameters: TestParams, Service: TestServiceName}
