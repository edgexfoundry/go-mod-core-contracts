...
var TestSchedule = Schedule{Created: TestBaseObject.Created, Modified: TestBaseObject.Modified, Origin: TestBaseObject.Origin, Name: TestScheduleName, Start: TestStart, End: TestEnd, Frequency: TestFreq2S, Cron: TestCRON, RunOnce: TestRunOnce}
