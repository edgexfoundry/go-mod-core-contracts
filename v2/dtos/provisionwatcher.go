...
type ProvisionWatcher struct {
	...
	ProfileName         string              `json:"profile" validate:"required,edgex-dto-none-empty-string"`
	ServiceName         string              `json:"service" validate:"required,edgex-dto-none-empty-string"`
