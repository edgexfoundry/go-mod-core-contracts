...
// DeviceProfileByNameWithQueryParams provides a mock function with given fields: ctx, name, queryParams
func (_m *DeviceProfileClient) DeviceProfileByNameWithQueryParams(ctx context.Context, name string, queryParams map[string]string) (responses.DeviceProfileResponse, errors.EdgeX) {
	ret := _m.Called(ctx, name, queryParams)

	if len(ret) == 0 {
		panic("no return value specified for DeviceProfileByNameWithQueryParams")
	}

	var r0 responses.DeviceProfileResponse
	var r1 errors.EdgeX
	if rf, ok := ret.Get(0).(func(context.Context, string, map[string]string) (responses.DeviceProfileResponse, errors.EdgeX)); ok {
		return rf(ctx, name, queryParams)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, map[string]string) responses.DeviceProfileResponse); ok {
		r0 = rf(ctx, name, queryParams)
	} else {
		r0 = ret.Get(0).(responses.DeviceProfileResponse)
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, map[string]string) errors.EdgeX); ok {
		r1 = rf(ctx, name, queryParams)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(errors.EdgeX)
		}
