...
// AllDevicesWithChildrenWithQueryParams provides a mock function with given fields: ctx, parent, maxLevels, labels, offset, limit, queryParams
func (_m *DeviceClient) AllDevicesWithChildrenWithQueryParams(ctx context.Context, parent string, maxLevels uint, labels []string, offset int, limit int, queryParams map[string]string) (responses.MultiDevicesResponse, errors.EdgeX) {
	ret := _m.Called(ctx, parent, maxLevels, labels, offset, limit, queryParams)

	if len(ret) == 0 {
		panic("no return value specified for AllDevicesWithChildrenWithQueryParams")
	}

	var r0 responses.MultiDevicesResponse
	var r1 errors.EdgeX
	if rf, ok := ret.Get(0).(func(context.Context, string, uint, []string, int, int, map[string]string) (responses.MultiDevicesResponse, errors.EdgeX)); ok {
		return rf(ctx, parent, maxLevels, labels, offset, limit, queryParams)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, uint, []string, int, int, map[string]string) responses.MultiDevicesResponse); ok {
		r0 = rf(ctx, parent, maxLevels, labels, offset, limit, queryParams)
	} else {
		r0 = ret.Get(0).(responses.MultiDevicesResponse)
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, uint, []string, int, int, map[string]string) errors.EdgeX); ok {
		r1 = rf(ctx, parent, maxLevels, labels, offset, limit, queryParams)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(errors.EdgeX)
		}
...
// AllDevicesWithQueryParams provides a mock function with given fields: ctx, labels, offset, limit, queryParams
func (_m *DeviceClient) AllDevicesWithQueryParams(ctx context.Context, labels []string, offset int, limit int, queryParams map[string]string) (responses.MultiDevicesResponse, errors.EdgeX) {
	ret := _m.Called(ctx, labels, offset, limit, queryParams)

	if len(ret) == 0 {
		panic("no return value specified for AllDevicesWithQueryParams")
	}

	var r0 responses.MultiDevicesResponse
	var r1 errors.EdgeX
	if rf, ok := ret.Get(0).(func(context.Context, []string, int, int, map[string]string) (responses.MultiDevicesResponse, errors.EdgeX)); ok {
		return rf(ctx, labels, offset, limit, queryParams)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []string, int, int, map[string]string) responses.MultiDevicesResponse); ok {
		r0 = rf(ctx, labels, offset, limit, queryParams)
	} else {
		r0 = ret.Get(0).(responses.MultiDevicesResponse)
	}

	if rf, ok := ret.Get(1).(func(context.Context, []string, int, int, map[string]string) errors.EdgeX); ok {
		r1 = rf(ctx, labels, offset, limit, queryParams)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(errors.EdgeX)
		}
...
// UpdateDeviceProperties provides a mock function with given fields: ctx, deviceName, request
func (_m *DeviceClient) UpdateDeviceProperties(ctx context.Context, deviceName string, request requests.DevicePropertiesRequest) (common.BaseResponse, errors.EdgeX) {
	ret := _m.Called(ctx, deviceName, request)

	if len(ret) == 0 {
		panic("no return value specified for UpdateDeviceProperties")
	}

	var r0 common.BaseResponse
	var r1 errors.EdgeX
	if rf, ok := ret.Get(0).(func(context.Context, string, requests.DevicePropertiesRequest) (common.BaseResponse, errors.EdgeX)); ok {
		return rf(ctx, deviceName, request)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, requests.DevicePropertiesRequest) common.BaseResponse); ok {
		r0 = rf(ctx, deviceName, request)
	} else {
		r0 = ret.Get(0).(common.BaseResponse)
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, requests.DevicePropertiesRequest) errors.EdgeX); ok {
		r1 = rf(ctx, deviceName, request)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(errors.EdgeX)
		}
