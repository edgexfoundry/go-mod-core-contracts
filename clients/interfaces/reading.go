...
type ReadingClient interface {
	...
	AllReadingsWithQueryParams(ctx context.Context, queryParams map[string]string) (responses.MultiReadingsResponse, errors.EdgeX)
	...
	ReadingsByDeviceNameWithQueryParams(ctx context.Context, name string, queryParams map[string]string) (responses.MultiReadingsResponse, errors.EdgeX)
	...
	ReadingsByResourceNameWithQueryParams(ctx context.Context, name string, queryParams map[string]string) (responses.MultiReadingsResponse, errors.EdgeX)
	...
	ReadingsByTimeRangeWithQueryParams(ctx context.Context, start, end int64, queryParams map[string]string) (responses.MultiReadingsResponse, errors.EdgeX)
	...
	ReadingsByResourceNameAndTimeRangeWithQueryParams(ctx context.Context, name string, start, end int64, queryParams map[string]string) (responses.MultiReadingsResponse, errors.EdgeX)
	...
	ReadingsByDeviceNameAndResourceNameWithQueryParams(ctx context.Context, deviceName, resourceName string, queryParams map[string]string) (responses.MultiReadingsResponse, errors.EdgeX)
	...
	ReadingsByDeviceNameAndResourceNameAndTimeRangeWithQueryParams(ctx context.Context, deviceName, resourceName string, start, end int64, queryParams map[string]string) (responses.MultiReadingsResponse, errors.EdgeX)
	...
	ReadingsByDeviceNameAndResourceNamesAndTimeRangeWithQueryParams(ctx context.Context, deviceName string, resourceNames []string, start, end int64, queryParams map[string]string) (responses.MultiReadingsResponse, errors.EdgeX)
}
