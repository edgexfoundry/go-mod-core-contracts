...
func TestNewSimpleReading(t *testing.T) {
	...
	tests := []struct {
		...
		{"String Array with spaces", common.ValueTypeStringArray, []string{"hello world", "foo bar"}, `["hello world","foo bar"]`},
		{"String Array with commas", common.ValueTypeStringArray, []string{"a,b", "c,d"}, `["a,b","c,d"]`},
		{"String Array with quotes", common.ValueTypeStringArray, []string{`say "hi"`, `it's`}, `["say \"hi\"","it's"]`},
